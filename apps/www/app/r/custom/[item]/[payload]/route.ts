...
import { buildQuery } from "@/lib/customize";
import { themeNames } from "@/lib/demos";
import { propsTable } from "@/lib/props-table";
import { getItem, itemSourcePath, SITE_URL } from "@/lib/registry";
...
export async function GET(_req: Request, { params }: RouteContext<"/r/custom/[item]/[payload]">) {
